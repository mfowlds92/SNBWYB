...
export function drawFromYanivDeck(state, playerIndex) {
  ...
  newState.yaniv.canSlam = canCardBeSlammedOntoDiscard(newState.yaniv.pendingDiscard, drawnCard);
...
export function slamYanivCard(state, playerIndex) {
  ...
  // add discard + slam card to discard pile
  newState.yaniv.discardPile.push(...newState.yaniv.pendingDiscard, newState.yaniv.justDrawnCard);
...
function advanceYanivTurn(state) {
